...
public class Q63_CopyLinkedList{
    class Node{
        int info;
        Node link;
    ...
    public void copyList(Q63_CopyLinkedList copy){
        if(first == null){
            System.out.println("List is empty");
            return ;
        }
    ...
    public static void main(String[] args) {
        ...
        Q63_CopyLinkedList list1 = new Q63_CopyLinkedList();
        ...
        while(true){
            ...
            switch(choice){
                ...
                case 3:
                    isTheEnd = true;
                    Q63_CopyLinkedList list2 = new Q63_CopyLinkedList();
