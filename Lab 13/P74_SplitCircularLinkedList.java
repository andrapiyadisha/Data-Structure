...
public class P74_SplitCircularLinkedList{
    class Node{
        int info;
        Node link;
        ...
        public void split(P74_SplitCircularLinkedList list2){
            if(first==null){
                System.out.println("List is empty");
                return;
            }
        ...
        P74_SplitCircularLinkedList list1 = new P74_SplitCircularLinkedList();
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                P74_SplitCircularLinkedList list2 = new P74_SplitCircularLinkedList();
                    list1.split(list2);
                    list1.display();
                    list2.display();
                    istheEnd = true;
