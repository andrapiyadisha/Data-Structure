...
public class Q59_CheakTwoSinglyLinkedList{
    class Node {
    ...
    public boolean check(Q59_CheakTwoSinglyLinkedList L) {
    ...
    public static void main(String[] args) {
        ...
        Q59_CheakTwoSinglyLinkedList list1 = new Q59_CheakTwoSinglyLinkedList();
        ...
        Q59_CheakTwoSinglyLinkedList list2 = new Q59_CheakTwoSinglyLinkedList();
        System.out.println("Please enter 1 if ypu want to enter elements,");
        System.out.println("Please enter 2 to display ll.");
        System.out.println("Please enter 3 if your insertion is completed.");
        while (true) {
